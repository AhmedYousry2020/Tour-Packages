...
<!-- end upper bar-->
 ...
 <form action="{{ route('login') }}" method="post" class="form-signin col-ml-auto formal">
            {{ csrf_field() }}
            {{ method_field('post') }}
 ...
 <div style="text-align: center;"> Don't have an account?<a href="siginup.html" >Register</a></div>
</form>
</div>
  <!--start footer-->
