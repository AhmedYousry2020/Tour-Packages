      ...
      <div class="modal-content">
        ...
        <div class="modal-footer" style="background-image:  linear-gradient(632deg, #4158d0 -20%, #c850c0 50%, #ffcc70 88%)  ">
            <a href="#" class="btn btn-default" data-dismiss="modal" style="color:black">Close</a>
                    ...
                    <a href="/packages/{{$package->id}}/edit" class=" btn btn-primary" style="margin-top: 5px;width: 90px">Edit</a>
                     <a href="/packages/{{$package->id}}/delete"  onclick="return confirm('Are you sure, you want to delete it?')" class=" btn btn-danger" style="margin-top: 5px;width: 90px">Delete</a>
